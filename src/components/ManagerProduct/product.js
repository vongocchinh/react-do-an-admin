...
class product extends Component {
  ...
  onClickIdDown = () => {
    this.props.onClickIdDown();
  };
  onClickIdUp = () => {
    this.props.onClickIdUp();
  };
  render() {
        ...
        <div className="main-right">
          <div className="main-content-table">
            <div className="button-group-product">
              <Button variant="contained">
                <Link className="button-group" to="/product-Category/dienthoai">
                  Điện thoại
                </Link>
              </Button>
              <Button variant="contained">
                <Link className="button-group" to="/product-Category/phukien">
                  {" "}
                  Phụ kiện
                </Link>
              </Button>
              <Button variant="contained">
                <Link className="button-group" to="/product-Category/laptop">
                  {" "}
                  Laptop
                </Link>
              </Button>
          ...
          <div className="pagination-custom">
            <ul id="page-numbers" className="page-numbers">
              <span
                className="chang-page arrow-left-thin-circle-outline"
                onClick={this.onClickIdDown}
              >
                <i className="far fa-arrow-alt-circle-left"></i>
              </span>
              {this.props.showIdPage}
              <span className="chang-page" onClick={this.onClickIdUp}>
            ...
            <span>
              <Dropdown className="dropDown-button">
                <Dropdown.Toggle
                  variant="success"
                  id="dropdown-basic"
                  className="mr-3 button-blue"
                >
                  By Get
                </Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item onClick={() => this.getBy(5)}>5</Dropdown.Item>
                  <Dropdown.Item onClick={() => this.getBy(10)}>
                    10
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => this.getBy(20)}>
                    20
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => this.getBy(30)}>
                    30
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => this.getBy(50)}>
                    50
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => this.getBy(100)}>
                    100
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
